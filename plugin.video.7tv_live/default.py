...
icon_base = xbmc.translatePath(xbmcaddon.Addon().getAddonInfo('path')+'/resource/').decode('utf-8')
...
def add_channel(name):
  ...
  liz = xbmcgui.ListItem(channels[name]['lable'], iconImage=icon_base + name + '.png', thumbnailImage="")
